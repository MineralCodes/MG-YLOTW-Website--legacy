...
<html>
	<head>
		...
		<meta name="keywords" content="Messianic, Sabbath, Yeshua, Yehovah, Holy Days, lunar calendar, biblical calendar, Jewish festivals, Passover, Sukkot, Sabbath Fellowship, Jewish Christian, Torah, Tenach, Torah scroll, Brit Chadashah, Rabbi, Messiah, Sermons, Audio, Recording">
		...
		<style type="text/css">
			...
			#archiveP a:link, #archiveP:visited {
				text-decoration: none;
			}
			#archiveP:hover, #archiveP a:active {
	...
	<body>
		<div id="wrapper">
 		 	...
 		 	<div id="content">
    			...
    			<p id="archiveP"><a href="archive.php" id="archiveLink">Audio Archive &raquo;</a></p>
  			</div>
  			<footer>
    			<ul>
      				<li><a href="index.shtml">Home</a></li>
